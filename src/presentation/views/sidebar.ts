    ...
    <aside class="w-[250px] h-full bg-[var(--color-things-sidebar)] flex flex-col overflow-y-auto select-none border-r border-[var(--color-things-divider)]">
      <nav class="flex-1 px-3 pt-3 pb-2">
        ...
        <ul class="space-y-0">
          ${projects.map(p => html`
            <li>
              <a href="#/projects/${p.id}" class="flex items-center gap-2.5 px-2 py-[4px] rounded text-[13px] transition-colors
        ...
        <ul class="space-y-0">
          ${tags.map(t => html`
            <li>
              <a href="#/tags/${t.id}" class="flex items-center gap-2.5 px-2 py-[4px] rounded text-[13px] transition-colors
...
function navItem(item: NavItem, currentPath: string): TemplateResult {
  ...
  return html`
    <li>
      <a href="#${item.path}" class="flex items-center gap-2.5 px-2 py-[4px] rounded text-[13px] transition-colors
